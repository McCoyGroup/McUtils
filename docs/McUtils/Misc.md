...
## <a class="collapse-link" data-toggle="collapse" href="#Tests-8320f2" markdown="1"> Tests</a> <a class="float-right" data-toggle="collapse" href="#Tests-8320f2"><i class="fa fa-chevron-down"></i></a>
 </div>
 <div class="collapsible-section collapsible-section-body collapse show" id="Tests-8320f2" markdown="1">
 - [Symbolics](#Symbolics)
- [TeXWriter](#TeXWriter)

<div class="collapsible-section">
 <div class="collapsible-section collapsible-section-header" markdown="1">
### <a class="collapse-link" data-toggle="collapse" href="#Setup-d0dcfb" markdown="1"> Setup</a> <a class="float-right" data-toggle="collapse" href="#Setup-d0dcfb"><i class="fa fa-chevron-down"></i></a>
 </div>
 <div class="collapsible-section collapsible-section-body collapse show" id="Setup-d0dcfb" markdown="1">
