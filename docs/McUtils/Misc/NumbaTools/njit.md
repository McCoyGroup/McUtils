...
[[source](https://github.com/McCoyGroup/McUtils/blob/master/McUtils/Misc/NumbaTools.py#L45)/
[edit](https://github.com/McCoyGroup/McUtils/edit/master/McUtils/Misc/NumbaTools.py#L45?message=Update%20Docs)]
</div>

```python
njit(*args, warn=True, **kwargs): 
```
