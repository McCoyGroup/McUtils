...
[CRESTJob](ExternalPrograms/Jobs/CREST/CRESTJob.md)   
   ...
   <div class="col" markdown="1">
[SBatchJob](ExternalPrograms/Jobs/SBatch/SBatchJob.md)   
</div>
</div>
  <div class="row">
   <div class="col" markdown="1">
[QChemJob](ExternalPrograms/Jobs/QChem/QChemJob.md)   
</div>
   <div class="col" markdown="1">
...
[build_templated_smiles](ExternalPrograms/SMILES/build_templated_smiles.md)   
  ...
  <div class="row">
   <div class="col" markdown="1">
[templated_smiles_iterator](ExternalPrograms/SMILES/templated_smiles_iterator.md)   
</div>
   <div class="col" markdown="1">
...
[GEOMDownloader](ExternalPrograms/GEOM/GEOMDownloader.md)   
   ...
   <div class="col" markdown="1">
[GEOMInternalsWrapper](ExternalPrograms/GEOM/GEOMInternalsWrapper.md)   
</div>
</div>
  <div class="row">
   <div class="col" markdown="1">
...
[ConformerEncoder](ExternalPrograms/Conformers/ConformerEncoder.md)   
  ...
  <div class="row">
   <div class="col" markdown="1">
[BondPatcher](ExternalPrograms/Conformers/BondPatcher.md)   
</div>
   <div class="col" markdown="1">
[prune_conformers_by_rmsd](ExternalPrograms/Conformers/prune_conformers_by_rmsd.md)   
</div>
   <div class="col" markdown="1">
[generate_conformer_ensemble](ExternalPrograms/Conformers/generate_conformer_ensemble.md)   
</div>
</div>
  <div class="row">
   <div class="col" markdown="1">
[ConformerLibrary](ExternalPrograms/ConformerLibrary/ConformerLibrary.md)   
</div>
   <div class="col" markdown="1">
...
## <a class="collapse-link" data-toggle="collapse" href="#Tests-40a5fc" markdown="1"> Tests</a> <a class="float-right" data-toggle="collapse" href="#Tests-40a5fc"><i class="fa fa-chevron-down"></i></a>
 </div>
 <div class="collapsible-section collapsible-section-body collapse show" id="Tests-40a5fc" markdown="1">
 - [CIFFiles](#CIFFiles)
...
- [SMIToDB](#SMIToDB)
- [QChemJob](#QChemJob)
- [TemplatedSmilesIterator](#TemplatedSmilesIterator)
- [ConformerEnsembles](#ConformerEnsembles)
- [ConformerLibraryFromTree](#ConformerLibraryFromTree)
- [CreateSmilesIteratorArchive](#CreateSmilesIteratorArchive)
- [ConformerLibraryFromSMILESDatabase](#ConformerLibraryFromSMILESDatabase)
- [ConformerLibraryFromQM9](#ConformerLibraryFromQM9)
- [ConformerLibraryFromGEOM](#ConformerLibraryFromGEOM)

<div class="collapsible-section">
 <div class="collapsible-section collapsible-section-header" markdown="1">
### <a class="collapse-link" data-toggle="collapse" href="#Setup-609de3" markdown="1"> Setup</a> <a class="float-right" data-toggle="collapse" href="#Setup-609de3"><i class="fa fa-chevron-down"></i></a>
 </div>
 <div class="collapsible-section collapsible-section-body collapse show" id="Setup-609de3" markdown="1">
...
#### <a name="EvaluationServer">EvaluationServer</a>
```python
...
#### <a name="SBatchFromPython">SBatchFromPython</a>
```python
...
#### <a name="PubChemAPI">PubChemAPI</a>
```python
...
#### <a name="SmilesChiralities">SmilesChiralities</a>
```python
...
#### <a name="TemplatedSmilesIterator">TemplatedSmilesIterator</a>
```python
...
#### <a name="ConformerEnsembles">ConformerEnsembles</a>
```python
...
#### <a name="ConformerLibraryFromTree">ConformerLibraryFromTree</a>
```python
...
#### <a name="CreateSmilesIteratorArchive">CreateSmilesIteratorArchive</a>
```python
...
#### <a name="ConformerLibraryFromSMILESDatabase">ConformerLibraryFromSMILESDatabase</a>
```python
...
#### <a name="ConformerLibraryFromQM9">ConformerLibraryFromQM9</a>
```python
...
#### <a name="ConformerLibraryFromGEOM">ConformerLibraryFromGEOM</a>
```python
