...
```
<div class="docs-source-link" markdown="1">
[[source](https://github.com/McCoyGroup/McUtils/blob/master/Plots/Plots/ListTriContourPlot.py#L1044)/
[edit](https://github.com/McCoyGroup/McUtils/edit/master/Plots/Plots/ListTriContourPlot.py#L1044?message=Update%20Docs)]
</div>
 </div>
</div>
