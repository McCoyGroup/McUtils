## <a id="McUtils.McUtils.Jupyter.Apps.Interfaces.OpenerHeader">OpenerHeader</a> 
...
theme: dict
```
<a id="McUtils.McUtils.Jupyter.Apps.Interfaces.OpenerHeader.__init__" class="docs-object-method">&nbsp;</a> 
```python
__init__(self, key, base_name=None, **kw): 
```
<div class="docs-source-link" markdown="1">
[[source](https://github.com/McCoyGroup/McUtils/blob/master/McUtils/Jupyter/Apps/Interfaces/OpenerHeader.py#L956)/
[edit](https://github.com/McCoyGroup/McUtils/edit/master/McUtils/Jupyter/Apps/Interfaces/OpenerHeader.py#L956?message=Update%20Docs)]
</div>


<a id="McUtils.McUtils.Jupyter.Apps.Interfaces.OpenerHeader.create_item" class="docs-object-method">&nbsp;</a> 
```python
