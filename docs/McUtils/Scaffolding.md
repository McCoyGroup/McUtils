...
## <a class="collapse-link" data-toggle="collapse" href="#Tests-287c6c" markdown="1"> Tests</a> <a class="float-right" data-toggle="collapse" href="#Tests-287c6c"><i class="fa fa-chevron-down"></i></a>
 </div>
 <div class="collapsible-section collapsible-section-body collapse show" id="Tests-287c6c" markdown="1">
 - [Schema](#Schema)
...
<div class="collapsible-section">
 <div class="collapsible-section collapsible-section-header" markdown="1">
### <a class="collapse-link" data-toggle="collapse" href="#Setup-f88c9f" markdown="1"> Setup</a> <a class="float-right" data-toggle="collapse" href="#Setup-f88c9f"><i class="fa fa-chevron-down"></i></a>
 </div>
 <div class="collapsible-section collapsible-section-body collapse show" id="Setup-f88c9f" markdown="1">
