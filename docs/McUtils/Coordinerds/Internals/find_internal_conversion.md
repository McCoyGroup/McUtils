...
[[source](https://github.com/McCoyGroup/McUtils/blob/master/McUtils/Coordinerds/Internals.py#L1099)/
[edit](https://github.com/McCoyGroup/McUtils/edit/master/McUtils/Coordinerds/Internals.py#L1099?message=Update%20Docs)]
</div>

```python
find_internal_conversion(internals, targets, triangles_and_dihedrons=None, canonicalize=True, missing_val='raise'): 
```
