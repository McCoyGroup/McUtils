...
[[source](https://github.com/McCoyGroup/McUtils/blob/master/McUtils/Coordinerds/Internals.py#L1493)/
[edit](https://github.com/McCoyGroup/McUtils/edit/master/McUtils/Coordinerds/Internals.py#L1493?message=Update%20Docs)]
</div>

```python
get_internal_triangles_and_dihedrons(internals, canonicalize=True, construct_shapes=True, prune_incomplete=True, validate=True, allow_partially_defined=True, create_dihedra=True): 
```
