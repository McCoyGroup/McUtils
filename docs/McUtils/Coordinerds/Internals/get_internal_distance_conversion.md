...
[[source](https://github.com/McCoyGroup/McUtils/blob/master/McUtils/Coordinerds/Internals.py#L1482)/
[edit](https://github.com/McCoyGroup/McUtils/edit/master/McUtils/Coordinerds/Internals.py#L1482?message=Update%20Docs)]
</div>

```python
get_internal_distance_conversion(internals, triangles_and_dihedrons=None, canonicalize=True, allow_completion=True, missing_val='raise', return_conversions=False): 
```
