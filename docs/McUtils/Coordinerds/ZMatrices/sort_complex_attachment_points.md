...
[[source](https://github.com/McCoyGroup/McUtils/blob/master/McUtils/Coordinerds/ZMatrices.py#L822)/
[edit](https://github.com/McCoyGroup/McUtils/edit/master/McUtils/Coordinerds/ZMatrices.py#L822?message=Update%20Docs)]
</div>

```python
sort_complex_attachment_points(fragment_inds, attachment_points: dict): 
```
