# <a id="McUtils.Coordinerds.Conveniences.zmatrix_embedding_coords">zmatrix_embedding_coords</a>
<div class="docs-source-link" markdown="1">
[[source](https://github.com/McCoyGroup/McUtils/blob/master/McUtils/Coordinerds/Conveniences.py#L119)/
[edit](https://github.com/McCoyGroup/McUtils/edit/master/McUtils/Coordinerds/Conveniences.py#L119?message=Update%20Docs)]
</div>

```python
zmatrix_embedding_coords(zmat_or_num_atoms): 
```
