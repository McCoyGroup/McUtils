# <a id="McUtils.McUtils.Coordinerds.Conveniences.parse_zmatrix_string">parse_zmatrix_string</a>
<div class="docs-source-link" markdown="1">
[[source](https://github.com/McCoyGroup/McUtils/blob/master/McUtils/Coordinerds/Conveniences.py#L237)/
[edit](https://github.com/McCoyGroup/McUtils/edit/master/McUtils/Coordinerds/Conveniences.py#L237?message=Update%20Docs)]
</div>

```python
parse_zmatrix_string(zmat): 
```
