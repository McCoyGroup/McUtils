# <a id="McUtils.Coordinerds.Conveniences.validate_zmatrix">validate_zmatrix</a>
<div class="docs-source-link" markdown="1">
[[source](https://github.com/McCoyGroup/McUtils/blob/master/McUtils/Coordinerds/Conveniences.py#L499)/
[edit](https://github.com/McCoyGroup/McUtils/edit/master/McUtils/Coordinerds/Conveniences.py#L499?message=Update%20Docs)]
</div>

```python
validate_zmatrix(ordering, allow_reordering=True, ensure_nonnegative=True): 
```
