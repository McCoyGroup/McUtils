...
[[source](https://github.com/McCoyGroup/McUtils/blob/master/McUtils/Docs/DocWalker.py#L1097)/
[edit](https://github.com/McCoyGroup/McUtils/edit/master/McUtils/Docs/DocWalker.py#L1097?message=Update%20Docs)]
</div>

```python
jdoc(obj, max_depth=1, engine=None, verbose=False, **etc): 
```
...
## <a class="collapse-link" data-toggle="collapse" href="#Details-ce71a7" markdown="1"> Details</a> <a class="float-right" data-toggle="collapse" href="#Details-ce71a7"><i class="fa fa-chevron-down"></i></a>
 </div>
 <div class="collapsible-section collapsible-section-body collapse " id="Details-ce71a7" markdown="1">
