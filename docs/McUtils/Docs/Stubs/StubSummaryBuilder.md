...
```python
__init__(self, out_dir='stubs', max_doc_len=800, min_words=5, write_sidecar_file=False, verbose=False, dispatcher=None, filter=None, exclude=<function default_exclude at 0x7f75d7c67280>): 
```
<div class="docs-source-link" markdown="1">
