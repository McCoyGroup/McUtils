...
Build the three-dimensional Cartesian matrix representation for selected group elements.
  ...
  - `permutations`: `object`
    > Atom permutations for each symmetry operation.
  - `:returns`: `np.ndarray`
...
[Bug](https://github.com/McCoyGroup/McUtils/issues/new?title=Documentation%20Improvement%20Needed)/[Request](https://github.com/McCoyGroup/McUtils/issues/new?title=Example%20Request)   
   ...
   <div class="col" markdown="1">
[Edit](https://github.com/McCoyGroup/McUtils/edit/gh-pages/ci/examples/McUtils/Symmetry/Symmetrizer/get_internal_permutation_symmetry_matrices.md)/[New](https://github.com/McCoyGroup/McUtils/new/gh-pages/?filename=ci/examples/McUtils/Symmetry/Symmetrizer/get_internal_permutation_symmetry_matrices.md)   
</div>
   <div class="col" markdown="1">
