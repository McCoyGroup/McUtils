...
[[source](https://github.com/McCoyGroup/McUtils/blob/master/McUtils/Numputils/CoordOps.py#L2043)/
[edit](https://github.com/McCoyGroup/McUtils/edit/master/McUtils/Numputils/CoordOps.py#L2043?message=Update%20Docs)]
</div>

```python
dist_basis(coords, i, j, nonzero_cutoff=1e-08): 
```
