...
[[source](https://github.com/McCoyGroup/McUtils/blob/master/McUtils/Numputils/CoordOps.py#L2280)/
[edit](https://github.com/McCoyGroup/McUtils/edit/master/McUtils/Numputils/CoordOps.py#L2280?message=Update%20Docs)]
</div>
...
Higher-order terms are exact zeros for these (linear) coordinates.
  ...
  - `:returns`: `list | tuple`
    > the expansion, or `(expansion, principal_axes)` if `return_frame`
