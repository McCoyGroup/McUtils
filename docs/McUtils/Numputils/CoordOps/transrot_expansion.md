...
[[source](https://github.com/McCoyGroup/McUtils/blob/master/McUtils/Numputils/CoordOps.py#L4090)/
[edit](https://github.com/McCoyGroup/McUtils/edit/master/McUtils/Numputils/CoordOps.py#L4090?message=Update%20Docs)]
</div>
...
Higher-order terms are zero.
  ...
  - `:returns`: `list | tuple`
    > the expansion, or `(expansion, frame)` if `return_frame`
