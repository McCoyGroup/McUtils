# <a id="McUtils.McUtils.Numputils.CoordOps.internal_coordinate_tensors">internal_coordinate_tensors</a>
<div class="docs-source-link" markdown="1">
[[source](https://github.com/McCoyGroup/McUtils/blob/master/McUtils/Numputils/CoordOps.py#L1679)/
[edit](https://github.com/McCoyGroup/McUtils/edit/master/McUtils/Numputils/CoordOps.py#L1679?message=Update%20Docs)]
</div>

```python
internal_coordinate_tensors(coords, specs, order=None, return_inverse=False, masses=None, **opts): 
```
