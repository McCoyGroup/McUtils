...
[[source](https://github.com/McCoyGroup/McUtils/blob/master/McUtils/Numputils/CoordOps.py#L2260)/
[edit](https://github.com/McCoyGroup/McUtils/edit/master/McUtils/Numputils/CoordOps.py#L2260?message=Update%20Docs)]
</div>

```python
dist_expansion(coords, i, j, order=1, left_atoms=None, right_atoms=None): 
```
