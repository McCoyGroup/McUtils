# <a id="McUtils.McUtils.Numputils.TensorDerivatives.vec_anglesin_deriv">vec_anglesin_deriv</a>
<div class="docs-source-link" markdown="1">
[[source](https://github.com/McCoyGroup/McUtils/blob/master/McUtils/Numputils/TensorDerivatives.py#L664)/
[edit](https://github.com/McCoyGroup/McUtils/edit/master/McUtils/Numputils/TensorDerivatives.py#L664?message=Update%20Docs)]
</div>

```python
vec_anglesin_deriv(A_expansion, B_expansion, order, unitized=False, return_unit_vectors=True, planar=None, up_vector=None, planar_threshold=1e-14): 
```
