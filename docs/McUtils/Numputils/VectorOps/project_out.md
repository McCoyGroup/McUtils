...
[[source](https://github.com/McCoyGroup/McUtils/blob/master/McUtils/Numputils/VectorOps.py#L1327)/
[edit](https://github.com/McCoyGroup/McUtils/edit/master/McUtils/Numputils/VectorOps.py#L1327?message=Update%20Docs)]
</div>

```python
project_out(vecs, basis, ndim=None, orthonormal=False): 
```
