...
[[source](https://github.com/McCoyGroup/McUtils/blob/master/McUtils/Numputils/VectorOps.py#L201)/
[edit](https://github.com/McCoyGroup/McUtils/edit/master/McUtils/Numputils/VectorOps.py#L201?message=Update%20Docs)]
</div>

```python
vec_rescale(vecs, target_range=None, axis=-1): 
```
