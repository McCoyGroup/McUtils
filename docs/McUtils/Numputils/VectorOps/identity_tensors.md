# <a id="McUtils.Numputils.VectorOps.identity_tensors">identity_tensors</a>
<div class="docs-source-link" markdown="1">
[[source](https://github.com/McCoyGroup/McUtils/blob/master/McUtils/Numputils/VectorOps.py#L900)/
[edit](https://github.com/McCoyGroup/McUtils/edit/master/McUtils/Numputils/VectorOps.py#L900?message=Update%20Docs)]
</div>
...
Return a stack of identity matrices broadcast over a leading batch shape.
  - `base_shape`: `int | tuple[int, ...]`
    > the leading (batch) shape to broadcast over
  - `ndim`: `int`
    > the dimension of each identity matrix
  - `:returns`: `np.ndarray`
    > the broadcast identity tensor, shape `base_shape + (ndim, ndim)`
