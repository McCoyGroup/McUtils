# <a id="McUtils.McUtils.Numputils.VectorOps.project_onto">project_onto</a>
<div class="docs-source-link" markdown="1">
[[source](https://github.com/McCoyGroup/McUtils/blob/master/McUtils/Numputils/VectorOps.py#L1219)/
[edit](https://github.com/McCoyGroup/McUtils/edit/master/McUtils/Numputils/VectorOps.py#L1219?message=Update%20Docs)]
</div>

```python
project_onto(vecs, basis, ndim=None, orthornomal=False): 
```
