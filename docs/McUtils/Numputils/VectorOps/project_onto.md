...
[[source](https://github.com/McCoyGroup/McUtils/blob/master/McUtils/Numputils/VectorOps.py#L1386)/
[edit](https://github.com/McCoyGroup/McUtils/edit/master/McUtils/Numputils/VectorOps.py#L1386?message=Update%20Docs)]
</div>

```python
project_onto(vecs, basis, ndim=None, orthonormal=False): 
```
