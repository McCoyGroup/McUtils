...
[[source](https://github.com/McCoyGroup/McUtils/blob/master/McUtils/Numputils/VectorOps.py#L2487)/
[edit](https://github.com/McCoyGroup/McUtils/edit/master/McUtils/Numputils/VectorOps.py#L2487?message=Update%20Docs)]
</div>
...
until no entry is divisible or `max_its` is reached.
  ...
  - `:returns`: `tuple[np.ndarray, np.ndarray]`
    > `(residuals, exponents)` — the co-factors and the powers of `k` removed
...
[Bug](https://github.com/McCoyGroup/McUtils/issues/new?title=Documentation%20Improvement%20Needed)/[Request](https://github.com/McCoyGroup/McUtils/issues/new?title=Example%20Request)   
   ...
   <div class="col" markdown="1">
[Edit](https://github.com/McCoyGroup/McUtils/edit/gh-pages/ci/examples/McUtils/Numputils/VectorOps/integer_exponent.md)/[New](https://github.com/McCoyGroup/McUtils/new/gh-pages/?filename=ci/examples/McUtils/Numputils/VectorOps/integer_exponent.md)   
</div>
   <div class="col" markdown="1">
