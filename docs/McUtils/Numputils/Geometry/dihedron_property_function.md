...
[[source](https://github.com/McCoyGroup/McUtils/blob/master/McUtils/Numputils/Geometry.py#L3793)/
[edit](https://github.com/McCoyGroup/McUtils/edit/master/McUtils/Numputils/Geometry.py#L3793?message=Update%20Docs)]
</div>

```python
dihedron_property_function(sample_dihed: 'DihedralTetrahedronData', field_name, disallowed_conversions=None, allow_completion=True, raise_on_missing=True, return_depth=False, cache=None): 
```
