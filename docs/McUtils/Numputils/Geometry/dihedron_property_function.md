...
[[source](https://github.com/McCoyGroup/McUtils/blob/master/McUtils/Numputils/Geometry.py#L3909)/
[edit](https://github.com/McCoyGroup/McUtils/edit/master/McUtils/Numputils/Geometry.py#L3909?message=Update%20Docs)]
</div>

```python
dihedron_property_function(sample_dihed: 'DihedralTetrahedronData', field_name, disallowed_conversions=None, allow_completion=True, raise_on_missing=True, return_depth=False, completion_handler=None, depth=0, cache=None): 
```
