...
[[source](https://github.com/McCoyGroup/McUtils/blob/master/McUtils/Numputils/TransformationMatrices.py#L1450)/
[edit](https://github.com/McCoyGroup/McUtils/edit/master/McUtils/Numputils/TransformationMatrices.py#L1450?message=Update%20Docs)]
</div>
...
original atoms with `find_coordinate_matching_permutation`.
  ...
  - `:returns`: `np.ndarray | tuple`
    > the induced permutation (or the row/column orderings)
