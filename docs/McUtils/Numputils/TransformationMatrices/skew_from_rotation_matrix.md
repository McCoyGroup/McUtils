...
[[source](https://github.com/McCoyGroup/McUtils/blob/master/McUtils/Numputils/TransformationMatrices.py#L590)/
[edit](https://github.com/McCoyGroup/McUtils/edit/master/McUtils/Numputils/TransformationMatrices.py#L590?message=Update%20Docs)]
</div>
...
Uses a Schur factorization and the Youla angles to rebuild the skew generator.
  - `rot_mat`: `np.ndarray`
    > the rotation matrix
  - `:returns`: `np.ndarray`
    > the strict-upper-triangle entries of the skew generator
