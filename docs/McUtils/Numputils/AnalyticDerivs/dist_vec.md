...
[[source](https://github.com/McCoyGroup/McUtils/blob/master/Numputils/AnalyticDerivs.py#L1113)/
[edit](https://github.com/McCoyGroup/McUtils/edit/master/Numputils/AnalyticDerivs.py#L1113?message=Update%20Docs)]
</div>

```python
dist_vec(coords, i, j, order=None): 
```
