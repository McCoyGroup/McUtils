## <a id="McUtils.McUtils.Zachary.Polynomials.DensePolynomial">DensePolynomial</a> 
...
<a id="McUtils.McUtils.Zachary.Polynomials.DensePolynomial.__init__" class="docs-object-method">&nbsp;</a> 
```python
__init__(self, coeffs, prefactor=None, shift=None, stack_dim=0): 
```
<div class="docs-source-link" markdown="1">
[[source](https://github.com/McCoyGroup/McUtils/blob/master/McUtils/Zachary/Polynomials/DensePolynomial.py#L59)/
[edit](https://github.com/McCoyGroup/McUtils/edit/master/McUtils/Zachary/Polynomials/DensePolynomial.py#L59?message=Update%20Docs)]
</div>


<a id="McUtils.McUtils.Zachary.Polynomials.DensePolynomial.__repr__" class="docs-object-method">&nbsp;</a> 
```python
__repr__(self): 
```
<div class="docs-source-link" markdown="1">
...
<a id="McUtils.McUtils.Zachary.Polynomials.DensePolynomial.from_tensors" class="docs-object-method">&nbsp;</a> 
```python
@classmethod
...
<a id="McUtils.McUtils.Zachary.Polynomials.DensePolynomial.shape" class="docs-object-method">&nbsp;</a> 
```python
@property
shape(self): 
```
...
<a id="McUtils.McUtils.Zachary.Polynomials.DensePolynomial.scaling" class="docs-object-method">&nbsp;</a> 
```python
@property
scaling(self): 
```
...
<a id="McUtils.McUtils.Zachary.Polynomials.DensePolynomial.coeffs" class="docs-object-method">&nbsp;</a> 
```python
@property
...
<a id="McUtils.McUtils.Zachary.Polynomials.DensePolynomial.coordinate_dim" class="docs-object-method">&nbsp;</a> 
```python
@property
coordinate_dim(self): 
```
...
<a id="McUtils.McUtils.Zachary.Polynomials.DensePolynomial.__mul__" class="docs-object-method">&nbsp;</a> 
```python
...
<a id="McUtils.McUtils.Zachary.Polynomials.DensePolynomial.__add__" class="docs-object-method">&nbsp;</a> 
```python
...
<a id="McUtils.McUtils.Zachary.Polynomials.DensePolynomial.shift" class="docs-object-method">&nbsp;</a> 
```python
...
<a id="McUtils.McUtils.Zachary.Polynomials.DensePolynomial.compute_shifted_coeffs" class="docs-object-method">&nbsp;</a> 
```python
@classmethod
...
<a id="McUtils.McUtils.Zachary.Polynomials.DensePolynomial.fill_tensors" class="docs-object-method">&nbsp;</a> 
```python
@classmethod
...
<a id="McUtils.McUtils.Zachary.Polynomials.DensePolynomial.extract_tensors" class="docs-object-method">&nbsp;</a> 
```python
@classmethod
...
<a id="McUtils.McUtils.Zachary.Polynomials.DensePolynomial.condense_tensors" class="docs-object-method">&nbsp;</a> 
```python
@classmethod
...
<a id="McUtils.McUtils.Zachary.Polynomials.DensePolynomial.coefficient_tensors" class="docs-object-method">&nbsp;</a> 
```python
@property
...
<a id="McUtils.McUtils.Zachary.Polynomials.DensePolynomial.unscaled_coefficient_tensors" class="docs-object-method">&nbsp;</a> 
```python
@property
...
<a id="McUtils.McUtils.Zachary.Polynomials.DensePolynomial.transform" class="docs-object-method">&nbsp;</a> 
```python
...
<a id="McUtils.McUtils.Zachary.Polynomials.DensePolynomial.outer" class="docs-object-method">&nbsp;</a> 
```python
outer(self, other): 
```
<div class="docs-source-link" markdown="1">
...
<a id="McUtils.McUtils.Zachary.Polynomials.DensePolynomial.deriv" class="docs-object-method">&nbsp;</a> 
```python
deriv(self, coord): 
```
<div class="docs-source-link" markdown="1">
...
<a id="McUtils.McUtils.Zachary.Polynomials.DensePolynomial.grad" class="docs-object-method">&nbsp;</a> 
```python
grad(self): 
```
<div class="docs-source-link" markdown="1">
...
<a id="McUtils.McUtils.Zachary.Polynomials.DensePolynomial.clip" class="docs-object-method">&nbsp;</a> 
```python
...
<a id="McUtils.McUtils.Zachary.Polynomials.DensePolynomial.make_sparse_backed" class="docs-object-method">&nbsp;</a> 
```python
