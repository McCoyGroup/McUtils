        ...
        **LLM Docstring**
        ...
        def deriv(r, e=1, inds=inds):
            ...
            **LLM Docstring**
            ...
            Evaluate the `n`-th radial derivative of the Gaussian kernel at radius `r`.
        ...
        **LLM Docstring**
        ...
        def deriv(r, e=1, inds=inds): # r will be a vector of zeros..., inds=None):
            ...
            **LLM Docstring**
            ...
            Evaluate the `n`-th-derivative value of the Gaussian kernel at `r = 0`.

            :param r: the radius (a vector of zeros)
            :type r: np.ndarray
            :return: the value at the origin
            :rtype: np.ndarray
            """
            if inds is not None and not isinstance(e, (int, float, np.integer, np.floating)):
                e = e[inds]
        ...
        **LLM Docstring**
        ...
        def deriv(r, o=3, inds=inds):
            ...
            **LLM Docstring**
            ...
            Evaluate the `n`-th radial derivative of the thin-plate-spline kernel at radius `r`.
        ...
        **LLM Docstring**
        ...
        def deriv(r, o=3, inds=inds):  # r will be a vector of zeros...
            ...
            **LLM Docstring**
            ...
            Evaluate the `n`-th-derivative value of the thin-plate-spline kernel at `r = 0`.
        ...
        **LLM Docstring**
        ...
        def deriv(r, k=3, d=None, inds=inds):
            ...
            **LLM Docstring**
            ...
            Evaluate the `n`-th radial derivative of the Wendland kernel at radius `r`.
        ...
        **LLM Docstring**
        ...
        def deriv(r, k=3, d=None, inds=inds):  # r will be a vector of zeros...
            ...
            **LLM Docstring**
            ...
            Evaluate the `n`-th-derivative value of the Wendland kernel at `r = 0`.
        ...
        **LLM Docstring**
        ...
        def deriv(r, inds=inds):
            ...
            **LLM Docstring**
            ...
            Evaluate the `n`-th radial derivative of the zero kernel at radius `r`.
        ...
        **LLM Docstring**
        ...
        def deriv(r, inds=inds):  # r will be a vector of zeros...
            ...
            **LLM Docstring**
            ...
            Evaluate the `n`-th-derivative value of the zero kernel at `r = 0`.
        ...
        **LLM Docstring**
        ...
        def deriv(r, a=1, inds=inds):
            ...
            **LLM Docstring**
            ...
            Evaluate the `n`-th radial derivative of the Morse kernel at radius `r`.
        ...
        **LLM Docstring**
        ...
        def deriv(r, o=1, inds=inds):
            ...
            **LLM Docstring**
            ...
            Evaluate the `n`-th radial derivative of the even-power kernel at radius `r`.
    ...
    def laguerre_deriv(n:int, inds=None):
        ...
        def deriv(r, k=3, shift=2.29428, inds=inds):
            ...
            **LLM Docstring**
            ...
            Evaluate the `n`-th radial derivative of the Laguerre kernel at radius `r`.
        ...
        **LLM Docstring**
        ...
        def deriv(r, e=1, k=3, shift=2.29428, inds=inds):
            ...
            **LLM Docstring**
            ...
            Evaluate the `n`-th radial derivative of the compact-Laguerre kernel at radius `r`.
