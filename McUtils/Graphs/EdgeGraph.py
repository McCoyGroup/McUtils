        ...
        **LLM Docstring**
        ...
        def match(test_counts, primary_counts=primary_counts, groups_counts=group_counts):
            ...
            **LLM Docstring**
            ...
            Match required primary and nested neighbor counts, resolving wildcard groups greedily against leftovers.

            :param test_counts: Required functional-group neighbor counts to test.
            :type test_counts: object

            :param primary_counts: Cached counts of immediate neighbor root labels.
            :type primary_counts: object

            :param groups_counts: Cached counts of complete nested neighbor patterns.
            :type groups_counts: object
