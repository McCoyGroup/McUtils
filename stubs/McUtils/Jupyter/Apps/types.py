import types, typing
__all__ = ['HTMLableType', 'WidgetableType', 'InterfaceElementType', 'ElementType', 'ClassListType', 'AttrsType']
...
class WidgetableType(typing.Protocol):
    ...
    def to_widget(self):
        ...
InterfaceElementBaseType = typing.Union[str, typing.Mapping, HTMLableType, WidgetableType, IPyHTMLableType, ImageableType]
InterfaceElementType = typing.Union[InterfaceElementBaseType, typing.Tuple[InterfaceElementBaseType, typing.Mapping]]
