"""Extracted from NumputilsTests.test_ParametricPath via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest NumputilsTests.test_ParametricPath"""
...
class NumputilsTests(TestCase):
    ...
    def test_ParametricPath(self):
        ...
        point = parametric_path_points([['BEZIER', [(0, 5), (5, 10), (10, 10)]], ['line', [(-5, 0), (-10, -5), (-10, -10)]], ['interp', [(0, 5), (5, 10), (10, 10)], {'k': 2}]])
