"""Extracted from NumputilsTests.test_Sparse via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest NumputilsTests.test_Sparse"""
...
class NumputilsTests(TestCase):
    ...
    def test_Sparse(self):
        ...
        array_4 = SparseArray.empty(shape=shape)
