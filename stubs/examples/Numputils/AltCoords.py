"""Extracted from NumputilsTests.test_AltCoords via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest NumputilsTests.test_AltCoords"""
...
class NumputilsTests(TestCase):
    ...
    def test_AltCoords(self):
        ...
        nput.internal_coordinate_tensors(coords, [{'wag': (0, 1, 2)}])
