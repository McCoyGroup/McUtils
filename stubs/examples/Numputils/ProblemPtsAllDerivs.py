"""Extracted from NumputilsTests.test_ProblemPtsAllDerivs via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest NumputilsTests.test_ProblemPtsAllDerivs"""
...
class NumputilsTests(TestCase):
    ...
    def test_ProblemPtsAllDerivs(self):
        ...
        diheds, dihed_derivs, dihed_derivs_2 = dihed_deriv(coords, [3], [4], [5], [0], order=2)
