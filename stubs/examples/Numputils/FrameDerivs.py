"""Extracted from NumputilsTests.test_FrameDerivs via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest NumputilsTests.test_FrameDerivs"""
...
class NumputilsTests(TestCase):
    ...
    def test_FrameDerivs(self):
        ...
        _ = nput.orientation_deriv(coords, (0, 1, 2, 3), (4, 5, 6), masses=masses, order=1)
