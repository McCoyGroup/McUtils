"""Extracted from ConverterTest.test_ZMatrixStep via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest ConverterTest.test_ZMatrixStep"""
...
class ConverterTest(TestCase):
    ...
    def test_ZMatrixStep(self):
        self.assertEquals(ZMatrixCoordinates.displacement(0.1), 0.1)
