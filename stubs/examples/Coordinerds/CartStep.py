"""Extracted from ConverterTest.test_CartStep via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest ConverterTest.test_CartStep"""
...
class ConverterTest(TestCase):
    ...
    def test_CartStep(self):
        self.assertEquals(CartesianCoordinates3D.displacement(0.1), 0.1)
