"""Extracted from ConverterTest.test_GetDihedrals via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest ConverterTest.test_GetDihedrals"""
...
class ConverterTest(TestCase):
    ...
    def test_GetDihedrals(self):
        ...
        self.assertEquals(round(dihed[0], 6), round(0.591539, 6))
