"""Extracted from ConverterTest.test_ChainCustomConversion via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest ConverterTest.test_ChainCustomConversion"""
...
class ConverterTest(TestCase):
    ...
    def test_ChainCustomConversion(self):
        ...
        self.assertAlmostEqual(np.sum(coord_set - old)[()], 0.0)
