"""Extracted from ConverterTest.test_ZMatrixToCartesian via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest ConverterTest.test_ZMatrixToCartesian"""
...
class ConverterTest(TestCase):
    ...
    def test_ZMatrixToCartesian(self):
        coords = self.test_zmats.convert(CartesianCoordinates3D, ordering=chain_zmatrix(16), use_rad=False)
