"""Extracted from ConverterTest.test_CartesianToZMatrixMultiJacobian3Timing1 via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest ConverterTest.test_CartesianToZMatrixMultiJacobian3Timing1"""
