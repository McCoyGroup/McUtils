"""Extracted from ConverterTest.test_CoordinateNumeration via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest ConverterTest.test_CoordinateNumeration"""
...
class ConverterTest(TestCase):
    ...
    def test_CoordinateNumeration(self):
        for c in enumerate_coordinate_sets([[0, 1, 2], [2, 3, 4, 5]], [(0, 1), (1, 2)]):
            print(c)
