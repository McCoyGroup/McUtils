"""Extracted from ConverterTest.test_CartesianToZMatrixAndBack via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest ConverterTest.test_CartesianToZMatrixAndBack"""
...
class ConverterTest(TestCase):
    ...
    def test_CartesianToZMatrixAndBack(self):
        ...
        cs2 = coord_set
        self.assertEqual(round(np.linalg.norm(cs2 - cs1), 8), 0.0)
