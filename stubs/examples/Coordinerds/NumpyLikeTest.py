"""Extracted from ConverterTest.test_NumpyLikeTest via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest ConverterTest.test_NumpyLikeTest"""
...
class ConverterTest(TestCase):
    ...
    def test_NumpyLikeTest(self):
        ...
        self.assertAlmostEqual(np.linalg.norm(coords - coords), 0.0)
