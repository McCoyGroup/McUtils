"""Extracted from ConverterTest.test_CartesianToZMatrixMultiJacobianTargeted via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest ConverterTest.test_CartesianToZMatrixMultiJacobianTargeted"""
