"""Extracted from ConverterTest.test_CartesianToZMatrixMultiJacobian2 via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest ConverterTest.test_CartesianToZMatrixMultiJacobian2"""
...
class ConverterTest(TestCase):
    ...
    def test_CartesianToZMatrixMultiJacobian2(self):
        ...
        self.assertEquals(njacob.shape, (10 * 3, 10 * 3, 10, 10 - 1, 3))
