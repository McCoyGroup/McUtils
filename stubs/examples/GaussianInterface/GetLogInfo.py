"""Extracted from GaussianInterfaceTests.test_GetLogInfo via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest GaussianInterfaceTests.test_GetLogInfo"""
