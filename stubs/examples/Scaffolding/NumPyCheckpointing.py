"""Extracted from ScaffoldingTests.test_NumPyCheckpointing via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest ScaffoldingTests.test_NumPyCheckpointing"""
