"""Extracted from ScaffoldingTests.test_HDF5Checkpointing via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest ScaffoldingTests.test_HDF5Checkpointing"""
