"""Extracted from PlotsTests.test_Scatter via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest PlotsTests.test_Scatter"""
...
class PlotsTests(TestCase):
    ...
    def test_Scatter(self):
        ...
        plot = ScatterPlot(*pts.T, aspect_ratio=2, image_size=250)
        plot.show()
        plot.close()
