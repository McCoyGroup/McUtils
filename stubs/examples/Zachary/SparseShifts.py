"""Extracted from ZacharyTests.test_SparseShifts via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest ZacharyTests.test_SparseShifts"""
...
class ZacharyTests(TestCase):
    ...
    def test_SparseShifts(self):
        d = SparsePolynomial({(): 1, (0,): 2, (1, 1): 3, (0, 1): -1}, ndim=2)
        print(d.terms)
