"""Extracted from ZacharyTests.test_InterpolatorExtrapolator1D via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest ZacharyTests.test_InterpolatorExtrapolator1D"""
...
class ZacharyTests(TestCase):
    ...
    def test_InterpolatorExtrapolator1D(self):
        ...
        interp = Interpolator(sin_grid, sin_vals, extrapolator=Interpolator.DefaultExtrapolator, extrapolation_order=1)
