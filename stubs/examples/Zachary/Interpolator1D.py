"""Extracted from ZacharyTests.test_Interpolator1D via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest ZacharyTests.test_Interpolator1D"""
