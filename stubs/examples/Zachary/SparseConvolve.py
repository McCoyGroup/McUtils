"""Extracted from ZacharyTests.test_SparseConvolve via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest ZacharyTests.test_SparseConvolve"""
...
class ZacharyTests(TestCase):
    ...
    def test_SparseConvolve(self):
        ...
        self.assertTrue(np.allclose(p3.coeffs, p4.coeffs.asarray()))
