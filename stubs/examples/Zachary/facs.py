"""Extracted from ZacharyTests.test_facs via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest ZacharyTests.test_facs"""
...
class ZacharyTests(TestCase):
    ...
    def test_facs(self):
        ...
        self.assertAlmostEqual(np.linalg.norm(facs - ans), 0.0)
