"""Extracted from ParallelizerTests.test_ScatterGatherMultiprocessing via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest ParallelizerTests.test_ScatterGatherMultiprocessing"""
