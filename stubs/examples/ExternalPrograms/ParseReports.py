"""Extracted from ExternalProgramsTest.test_ParseReports via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest ExternalProgramsTest.test_ParseReports"""
