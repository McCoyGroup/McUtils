"""Extracted from CombinatoricsTests.test_GenericPartitions via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest CombinatoricsTests.test_GenericPartitions"""
...
class CombinatoricsTests(TestCase):
    ...
    def test_GenericPartitions(self):
        raise Exception(UniquePartitions([3, 2, 1, 0, 0, 0]).partitions([3, 2, 1]))
