"""Extracted from CombinatoricsTests.test_Partitions2D via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest CombinatoricsTests.test_Partitions2D"""
...
class CombinatoricsTests(TestCase):
    ...
    def test_Partitions2D(self):
        print(IntegerPartitioner2D.get_partitions([3, 2, 1], [2, 2, 2]))
        raise Exception(...)
